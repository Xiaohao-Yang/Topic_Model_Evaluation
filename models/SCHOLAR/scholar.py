...
class Scholar(object):
    ...
    def __init__(self, config, embedding_model, alpha=1.0, learning_rate=0.001, init_embeddings=None, update_embeddings=True,
    ...
    def fit(self, X, Y, PC, TC, eta_bn_prop=1.0, l1_beta=None, l1_beta_c=None, l1_beta_ci=None, current_model=None):
        """
...
class torchScholar(nn.Module):
    ...
    def forward(self, X, Y, PC, TC, compute_loss=True, do_average=True, eta_bn_prop=1.0, var_scale=1.0, l1_beta=None, l1_beta_c=None, l1_beta_ci=None, hot=None, compute_theta=None):
        """
